  ...
  return (
    <section className="py-20 md:py-24 section-light">
      ...
      <div className="max-w-3xl mx-auto px-5">
        <h2 className="text-h2 font-heading font-semibold text-rich-black text-center mb-3">Questions, answered</h2>
        <p className="text-center text-stone mb-12">Everything you need to know before you start.</p>
        <div className="space-y-3">
          {FAQS.map(f => (
            <details key={f.q} className="group glass-card-light glass-highlight py-5 px-6 cursor-pointer">
              <summary className="flex items-center justify-between font-medium text-rich-black list-none text-[0.9375rem]">
                {f.q}
                <span className="material-symbols-rounded msym text-basil transition-transform duration-200 group-open:rotate-180 shrink-0 ml-4">expand_more</span>
              </summary>
