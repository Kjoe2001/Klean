...
export default function Page() {
  return (<><MarketingNav />
    <main className="max-w-3xl mx-auto px-5 py-14 animate-rise">
      ...
      <div className="glass p-7 text-[14px] leading-relaxed text-slate-600 dark:text-slate-300 whitespace-pre-line">{`Sales & Enterprise: hello@zelvoo.app\nSupport: support@zelvoo.app\n\nAccra, Ghana · GMT\n\nFor enterprise plans, custom AI training, or partnership enquiries, email with the subject 'Enterprise'.`}</div>
    </main></>);
}
