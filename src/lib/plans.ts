...
export const PLANS: Record<PlanKey, any> = {
  ...
  weekly: { name:'Weekly', price:2.25, days:7, credits:55, tagline:'GH₵35/week · 55 credits',
  ...
  starter:{ name:'Starter', price:6.10, days:7, credits:165, tagline:'GH₵95/week · 165 credits',
    perks:['165 credits / week','All text tools unlocked','PDF + PowerPoint export','1 brand workspace'],
