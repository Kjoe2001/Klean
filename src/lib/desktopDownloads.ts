...
export const desktopRelease = {
  ...
  tag:
    process.env.NEXT_PUBLIC_DESKTOP_RELEASE_TAG?.trim() &&
    process.env.NEXT_PUBLIC_DESKTOP_RELEASE_TAG?.trim() !== 'desktop-v0.1.1'
      ? process.env.NEXT_PUBLIC_DESKTOP_RELEASE_TAG.trim()
      : 'desktop-v0.1.2',
  // Example repo: Kjoe2001/zelvo
  repo: process.env.NEXT_PUBLIC_DESKTOP_GITHUB_REPO || 'Kjoe2001/zelvo',
  version:
    process.env.NEXT_PUBLIC_DESKTOP_RELEASE_VERSION?.trim() &&
    process.env.NEXT_PUBLIC_DESKTOP_RELEASE_VERSION?.trim() !== '0.1.1'
      ? process.env.NEXT_PUBLIC_DESKTOP_RELEASE_VERSION.trim()
      : '0.1.2',
  // Example:
